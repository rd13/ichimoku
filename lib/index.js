...
var Ichimoku = function () {
	function Ichimoku(input) {
		...
		this.generator = /*#__PURE__*/_regenerator2.default.mark(function _callee() {
			var result, tick, period, periodCounter, spanCounter, lagCounter, highs, lows, closes, spanAs, spanBs, lags, conversionPeriodLow, conversionPeriodHigh, basePeriodLow, basePeriodHigh, spanbPeriodLow, spanbPeriodHigh, conversionLine, baseLine, spanA, spanB, close;
